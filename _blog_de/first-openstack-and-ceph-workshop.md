...
The plan: two groups of four participants each, same workshop content, adapted each time to what the group actually needed. In the first group, one participant couldn't make it. So we ran with three engineers and one team lead.
